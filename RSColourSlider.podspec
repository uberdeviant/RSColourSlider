...
TODO: Add long description of the pod here.
  ...
  s.author           = { 'uberdeviant' => 'salimov29@gmail.com' }
  s.source           = { :git => 'https://github.com/uberdeviant/RSColourSlider.git', :tag => s.version.to_s }
  # s.social_media_url = 'https://twitter.com/<TWITTER_USERNAME>'

  s.ios.deployment_target = '8.0'

  s.source_files = 'RSColourSlider/Classes/**/*'
